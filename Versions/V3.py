...
class V3:
    ...
    def __init__(
        ...
        ============================================================
        The only major difference is that in this version, the function used to calculate the Learning Rate is the risk function defined in OptimizersMath, But with an squared EMA of kappa, meant to emulate the table, (check readme):
        ```
        ...
        V3 version is the best version, yet it largely underperforms on terrains characterized by negative curvature or sinusodial terrains.
        """
