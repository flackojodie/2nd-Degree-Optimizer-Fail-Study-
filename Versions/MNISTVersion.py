...
class V3:
    ...
    def __init__(
        ...
        ============================================================
        The function used to calculate the Learning Rate is the risk function defined in OptimizersMath:
        ```
        ...
        MNIST version is the architecture I used while putting the optimizer against Adam on Digit MNIST dataset (check CurvatureOptimizerTestRunsTerrains.ipynb).
        """
